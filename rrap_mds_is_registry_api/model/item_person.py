...
class ItemPerson(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, first_name, last_name, email, id, created_timestamp, updated_timestamp, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_name, first_name, last_name, email, id, created_timestamp, updated_timestamp, *args, **kwargs):  # noqa: E501
        """ItemPerson - a model defined in OpenAPI
