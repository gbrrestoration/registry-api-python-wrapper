...
class ModelRunWorkflowDefinitionDomainInfo(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, software, input_templates, output_templates, *args, **kwargs):  # noqa: E501
        """ModelRunWorkflowDefinitionDomainInfo - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_name, software, input_templates, output_templates, *args, **kwargs):  # noqa: E501
        """ModelRunWorkflowDefinitionDomainInfo - a model defined in OpenAPI
