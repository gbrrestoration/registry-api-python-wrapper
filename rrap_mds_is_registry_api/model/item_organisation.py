...
class ItemOrganisation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, display_name, name, id, created_timestamp, updated_timestamp, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, display_name, name, id, created_timestamp, updated_timestamp, *args, **kwargs):  # noqa: E501
        """ItemOrganisation - a model defined in OpenAPI
