...
class ModelRunWorkflowDefinitionFetchResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, status, *args, **kwargs):  # noqa: E501
        """ModelRunWorkflowDefinitionFetchResponse - a model defined in OpenAPI
