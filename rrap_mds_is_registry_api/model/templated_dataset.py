...
class TemplatedDataset(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'template': (TemplateResource,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, template, dataset_type, dataset, *args, **kwargs):  # noqa: E501
        """TemplatedDataset - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, template, dataset_type, dataset, *args, **kwargs):  # noqa: E501
        """TemplatedDataset - a model defined in OpenAPI
